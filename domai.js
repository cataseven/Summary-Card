      ...
      cards: [
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} on', icon: 'mdi:lightbulb-on', color: 'orange' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} on', icon: 'mdi:power-plug', color: 'orange' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} detected', icon: 'mdi:alert-circle', color: 'orange' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} active', icon: 'mdi:thermostat', color: 'orange' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} open', icon: 'mdi:window-shutter-open', color: 'red' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} playing', icon: 'mdi:cast-connected', color: 'dodgerblue' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} at home', icon: 'mdi:account-group', color: 'green' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} unlocked', icon: 'mdi:lock-open-variant', color: 'red' },
        ...
        },
        {
          ...
          styles: [
            ...
            { condition: 'any_active', text: '{count} cleaning', icon: 'mdi:robot-vacuum-variant', color: 'dodgerblue' },
